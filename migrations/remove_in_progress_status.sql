-- Remove 'in_progress' status from projects and ideas
-- Convert existing 'in_progress' records to 'actively_working'
-- New statuses: 'planning', 'actively_working', 'blocked', 'on_hold', 'completed', 'trashed'

-- Update existing projects with in_progress to actively_working
UPDATE projects SET status = 'actively_working' WHERE status = 'in_progress';

-- Update existing ideas with in_progress to actively_working
UPDATE ideas SET status = 'actively_working' WHERE status = 'in_progress';
